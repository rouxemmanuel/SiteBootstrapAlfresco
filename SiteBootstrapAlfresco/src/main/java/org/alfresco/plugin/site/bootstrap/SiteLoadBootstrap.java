package org.alfresco.plugin.site.bootstrap;
 ...
 * 
 * @author Nick Burch and Emmanuel Roux
 */
public class SiteLoadBootstrap extends AbstractPatch {
    ...
    // Logger
    private static final Log logger = LogFactory.getLog(SiteLoadBootstrap.class);
    ...
    {
		checkPropertyNotNull(getId(), "id");
        checkPropertyNotNull(getDescription(), "description");
    ...
    public String toString()
    {
        ...
        sb.append("Patch")
          ...
          .append(", ignored=").append(isIgnored())
          .append("]");
        return sb.toString();
    }
